...
<body>
    ...
    <form enctype="multipart/form-data" action="/course/update" method="POST">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input class="form-control" type="text" name="title" id="titles" placeholder="{{$course->title}}">
            </div>
        </div>
        <div class="form-group row">
            <label class="col-sm-2 col-form-label" for="description">Description</label>
            <div class="col-sm-10">
                <input class="form-control" type="text" name="desc" id="description" placeholder="{{$course->desc}}">
            </div>
        </div>
